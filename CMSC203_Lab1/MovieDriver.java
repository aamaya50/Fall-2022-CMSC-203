...
public class MovieDriver {
	...
	public static void main(String[] args) {
		...
		//do-while loop since it is unknown how many times a user might repeat the program
		do {
		...
		}while(answer.equalsIgnoreCase("y"));	//do-while loop keeps repeating as long as the answer from the user is a single "y"
